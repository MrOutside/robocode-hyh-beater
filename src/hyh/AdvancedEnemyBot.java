...
public class AdvancedEnemyBot extends EnemyBot {
  //Declare 2 new private variables in AdvancedEnemyBot called: x and y. They will be of type double
  private double x;
  private double y;
  /**
  ...
  /**
   * call parent reset method to reset those variables in parent class.
   * also reset the variables in this class.
   */
  public void reset() {
    super.reset();
    x = 0;
